...
export const ProductShowcase = () => {
  ...
  return (
    ...
    <div className="md:w-full  items-center">
      <div className="flex items-center justify-center text-center flex-col py-4 px-5 gap-6">
        <div className="py-2">
          <p
      ...
      font-semibold rounded-full md:text-lg"
        ...
        <div className="text-[1.4rem] md:text-2xl font-normal md:max-w-[45rem] mb-6">
      ...
      <div className="px-8 py-24 relative flex justify-center items-center my-16 md:my-52 lg:my-96 ">
      ...
      <div className="py-6 px-10 md:px-14 lg:px-20 gap-10 grid md:grid-cols-2 lg:grid-cols-4 mx-5">
        {
          ProductData.map((items, index) => (
          <div key={index} className="flex flex-col md:gap-3 gap-1 mt-5 p-2">
          <i className={`${items.img} text-2xl md:text-2xl`} ></i>
          <div className="font-semibold text-xl md:text-2xl">{items.title}</div>
          <div className="text-lg md:text-xl">{items.subtitle}</div>
